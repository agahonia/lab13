...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        TreeNode getNodeWithName(String targetName)
        {
            ...
            for (TreeNode child: children)
            {
            	...
            	TreeNode n1 = child.getNodeWithName(targetName);
               	if (n1 != null)
               	{
               		return n1;
               	}
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            TreeNode traverseRoot = this.parent;
            while (traverseRoot != null)
            {
            	ancestors.add(traverseRoot);
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Missing colon.");
		...
		else
		{
			...
			if (parentNode == null)
			{
				throw new TreeException("Can't find that node.");
			}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException(name1 + " isn't found"); //Throw a TreeException with a useful message
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null)
			throw new TreeException(name2 + " isn't found"); //Throw TreeException with a useful message
